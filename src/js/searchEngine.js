...
export class SearchEngine {
  ...
  getCommercialAlias(query) {
    ...
    const rules = [
      ...
      {
        terms: ['zapatillas deportivas sinteticas', 'zapatillas deportivas', 'zapatilla sintetica'],
        codes: ['6402190000', '640219'],
        officialTerm: 'Zapatillas deportivas sintéticas',
        generalCode: '6402.19.00.00',
        generalTitle: 'Calzado deportivo con suela y parte superior de caucho o plástico',
        guidance: 'Las zapatillas deportivas sintéticas sin capellada de cuero ni textil se clasifican en la subpartida 6402.19.00.00.'
      },
      {
        terms: ['zapatos de vestir de cuero', 'zapato de cuero', 'zapatos de cuero natural', 'zapato de vestir'],
        codes: ['6403999000', '640399'],
        officialTerm: 'Zapatos de cuero natural',
        generalCode: '6403.99.90.00',
        generalTitle: 'Calzado con suela de caucho, plástico o cuero natural y parte superior de cuero natural',
        guidance: 'Los zapatos de vestir de cuero natural corresponden a la subpartida 6403.99.90.00.'
      },
      {
        terms: ['pantalon jean denim', 'jean denim', 'pantalon jean', 'jeans denim'],
        codes: ['6203421000', '620342'],
        officialTerm: 'Pantalones de mezclilla (Denim) de algodón',
        generalCode: '6203.42.10.00',
        generalTitle: 'Pantalones largos de tejido de mezclilla ("denim") de algodón para hombres o niños',
        guidance: 'Los pantalones jeans de algodón corresponden a la subpartida 6203.42.10.00.'
      },
      {
        terms: ['cafe tostado en grano', 'cafe tostado', 'cafe en grano'],
        codes: ['0901210000', '090121'],
        officialTerm: 'Café tostado sin descafeinar',
        generalCode: '0901.21.00.00',
        generalTitle: 'Café tostado, sin descafeinar, en grano o molido',
        guidance: 'El café tostado en grano se clasifica en la subpartida 0901.21.00.00.'
      },
      {
        terms: ['arroz blanco pulido', 'arroz blanco', 'arroz pulido de grano largo'],
        codes: ['1006300000', '100630'],
        officialTerm: 'Arroz blanqueado o pulido',
        generalCode: '1006.30.00.00',
        generalTitle: 'Arroz blanqueado o pulido, incluso pulido o glaseado',
        guidance: 'El arroz blanco procesado/pulido corresponde a la subpartida 1006.30.00.00.'
      },
      {
        terms: ['ron de caña', 'ron de cana', 'ron', 'licor de ron', 'ron 750ml'],
        codes: ['220890', '220840', '2208909000'],
        officialTerm: 'Ron y aguardientes de caña / Licores',
        generalCode: '2208.40 / 2208.90',
        generalTitle: 'Ron y demás aguardientes o licores',
        guidance: 'El ron de caña y licores destilados se clasifican en la partida 2208.'
      },
      {
        terms: ['paracetamol', 'paracetamol 500mg', 'pastillas paracetamol'],
        codes: ['3004902900', '300490'],
        officialTerm: 'Medicamentos dosificados / Paracetamol',
        generalCode: '3004.90.29.00',
        generalTitle: 'Los demás medicamentos para la venta al por menor (DIGEMID)',
        guidance: 'El paracetamol acondicionando para la venta directa al por menor se clasifica en la subpartida 3004.90.29.00 (Requiere DIGEMID).'
      },
      {
        terms: ['crema facial hidratante', 'crema facial', 'bloqueador solar fps 50', 'bloqueador solar'],
        codes: ['3304990000', '330499'],
        officialTerm: 'Cosméticos y cremas de belleza / Cuidado de la piel',
        generalCode: '3304.99.00.00',
        generalTitle: 'Preparaciones para el cuidado de la piel y cosméticos',
        guidance: 'Las cremas faciales y bloqueadores solares corresponden a la subpartida 3304.99.00.00 (Requiere NSO DIGEMID).'
      },
      {
        terms: ['auto suv 2.0l', 'auto suv', 'camioneta suv', 'automovil de pasajeros'],
        codes: ['8703239040', '870323'],
        officialTerm: 'Automóviles de turismo / SUV',
        generalCode: '8703.23.90.40',
        generalTitle: 'Automóviles y vehículos SUV de cilindrada entre 1,500 cm³ y 3,000 cm³',
        guidance: 'Las camionetas SUV de 2.0L corresponden a la subpartida 8703.23.90.40.'
      },
      {
        terms: ['bomba centrifuga para agua', 'bomba centrifuga', 'bomba de agua'],
        codes: ['8413700000', '841370'],
        officialTerm: 'Bombas centrífugas para líquidos',
        generalCode: '8413.70.00.00',
        generalTitle: 'Las demás bombas centrífugas para líquidos',
        guidance: 'Las bombas centrífugas de agua corresponden a la subpartida 8413.70.00.00.'
      },
      {
        terms: ['valvula de bola de acero inoxidable', 'valvula de bola', 'valvula acero inoxidable'],
        codes: ['8481800000', '848180'],
        officialTerm: 'Válvulas y órganos similares para tuberías',
        generalCode: '8481.80.00.00',
        generalTitle: 'Válvulas de bola, compuerta, retención o mariposa para tuberías',
        guidance: 'Las válvulas de bola de acero inoxidable corresponden a la subpartida 8481.80.00.00.'
      },
      {
        terms: ['sensor fotoelectrico industrial', 'sensor fotoelectrico', 'sensor industrial'],
        codes: ['8536509000', '853650'],
        officialTerm: 'Interruptores y sensores fotoeléctricos',
        generalCode: '8536.50.90.00',
        generalTitle: 'Los demás interruptores y relés para tensión <= 1,000 V',
        guidance: 'Los sensores fotoeléctricos industriales corresponden a la subpartida 8536.50.90.00.'
      },
      {
        terms: ['cable de fibra optica monomodo', 'cable de fibra optica', 'fibra optica'],
        codes: ['8544700000', '854470'],
        officialTerm: 'Cables de fibras ópticas',
        generalCode: '8544.70.00.00',
        generalTitle: 'Cables de fibras ópticas constituidos por fibras enfundadas individualmente',
        guidance: 'Los cables de fibra óptica corresponden a la subpartida 8544.70.00.00.'
      },
      {
        terms: ['juguete de plastico', 'juguete plastico'],
        codes: ['9503009900', '950300'],
        officialTerm: 'Juguetes de plástico',
        generalCode: '9503.00.99.00',
        generalTitle: 'Los demás juguetes de plástico (Requiere DIGESA)',
        guidance: 'Los juguetes de plástico corresponden a la subpartida 9503.00.99.00.'
      },
      {
        terms: ['mueble de madera para oficina', 'mueble de madera'],
        codes: ['9403600000', '940360'],
        officialTerm: 'Muebles de madera',
        generalCode: '9403.60.00.00',
        generalTitle: 'Los demás muebles de madera para oficina o hogar',
        guidance: 'Los muebles de madera corresponden a la subpartida 9403.60.00.00.'
      },
      {
        terms: ['suplemento de proteina de suero', 'proteina de suero', 'suplemento proteina'],
        codes: ['2106909900', '210690'],
        officialTerm: 'Preparaciones alimenticias / Suplementos',
        generalCode: '2106.90.99.00',
        generalTitle: 'Las demás preparaciones alimenticias no expresadas ni comprendidas en otra parte',
        guidance: 'Los suplementos alimenticios de proteína de suero corresponden a la subpartida 2106.90.99.00.'
      },
      {
        terms: ['reloj inteligente smartwatch', 'reloj inteligente', 'smartwatch'],
        codes: ['8517629000', '851762'],
        officialTerm: 'Smartwatches / Aparatos de transmisión de datos',
        generalCode: '8517.62.90.00',
        generalTitle: 'Aparatos para la recepción, conversión y transmisión de datos o voz',
        guidance: 'Los relojes inteligentes Smartwatch corresponden a la subpartida 8517.62.90.00.'
      },
      {
        terms: ['monitores para computadora', 'monitor para computadora', 'monitor pc', 'monitores', 'pantalla para computadora'],
        codes: ['852852', '852872', '852859'],
        officialTerm: 'Monitores de los tipos utilizados con computadoras',
        generalCode: '8528.52.00.00',
        generalTitle: 'Monitores proyectados exclusivamente para computadoras de la partida 84.71',
        guidance: 'Los monitores para computadoras corresponden a la partida 85.28.'
      },
      {
        terms: ['televisor smart tv 55', 'televisor smart tv', 'smart tv'],
        codes: ['8528720000', '852872'],
        officialTerm: 'Receptores de televisión en color',
        generalCode: '8528.72.00.00',
        generalTitle: 'Aparatos receptores de televisión en color (Smart TV)',
        guidance: 'Los televisores Smart TV corresponden a la subpartida 8528.72.00.00.'
      },
      {
        terms: ['trimovil pasajeros mototaxi 200cc', 'trimovil pasajeros', 'mototaxi 200cc', 'mototaxi'],
        codes: ['8703210000', '870321'],
        officialTerm: 'Trimóviles / Mototaxis para pasajeros',
        generalCode: '8703.21.00.00',
        generalTitle: 'Vehículos automóviles de 3 ruedas (Mototaxis) de cilindrada <= 1,000 cc',
        guidance: 'Los mototaxis o trimóviles para pasajeros corresponden a la subpartida 8703.21.00.00.'
      },
      {
        terms: ['ropa usada en fardos prohibida', 'ropa usada en fardos', 'ropa usada'],
        codes: ['6309000000', '630900'],
        officialTerm: 'Artículos de prendería / Ropa usada (PROHIBIDA)',
        generalCode: '6309.00.00.00',
        generalTitle: 'Artículos de prendería (Ropa usada) — IMPORTACIÓN PROHIBIDA EN EL PERÚ',
        guidance: 'La ropa usada en fardos se clasifica en la subpartida 6309.00.00.00 y su importación comercial está PROHIBIDA por Ley 28491 / Ley 28514.'
      },
      {
  ...
  resolveEntity(item) {
    ...
    if (code.startsWith('9302') || code.startsWith('9303') || desc.includes('arma') || desc.includes('explosivo')) {
      return {
        ...
        momento_tramite: 'Previo al embarque',
        fuente_oficial: 'SUCAMEC / Portal VUCE',
        ultima_verificacion: '2022-12-31',
        restriccion: '🔴 Requiere Autorización e Inspección SUCAMEC.'
      };
    }

    return {
      mercanciaRestringida: 'No',
      entidad: 'SUNAT / Libre Comercialización',
      entidad_siglas: 'SUNAT',
      estado_regulacion: 'Libre',
      badge_class: 'adv-0',
      ...
      momento_tramite: 'No aplica',
      fuente_oficial: 'SUNAT Operatividad Aduanera',
      ultima_verificacion: '2022-12-31',
      restriccion: '🟢 Mercancía de Libre Comercialización en el Perú.'
    };
  }

  getTlcAnalysis(item, countryCode = 'NMF') {
    if (!item) return null;
    const generalRate = Number(item.adValorem || 0);

    const tlcMap = {
      'NMF': {
        nombre: 'Arancel General / Nación Más Favorecida (NMF)',
        estado: 'Vigente',
        generalRate: `${generalRate}%`,
        preferentialRate: `${generalRate}%`,
        preferenciaAplicable: 'No aplica (Arancel Base)',
        origenDeclarado: 'Cualquier Origen',
        pruebaOrigen: 'No requerida',
        fuente: 'SUNAT Operatividad Aduanera',
        observaciones: 'Arancel base general arancelario sin desgravación.'
      },
      'CN': {
        nombre: 'TLC Perú - China',
        estado: 'Vigente',
        generalRate: `${generalRate}%`,
        preferentialRate: generalRate === 0 ? '0%' : 'Por verificar',
        preferenciaAplicable: generalRate === 0 ? 'Sí (0% General)' : 'Por verificar',
        origenDeclarado: 'República Popular China (CN)',
        pruebaOrigen: 'Certificado de Origen TLC Perú-China (Formato Oficial)',
        fuente: 'MINCETUR / Acuerdos Comerciales del Perú',
        observaciones: generalRate === 0 ? 'La mercancía ya tributa 0% en el Arancel General NMF.' : 'No se pudo verificar automáticamente la preferencia arancelaria. Requiere comprobación del código de 10 dígitos en el cronograma del TLC.'
      },
      'US': {
        nombre: 'TLC Perú - Estados Unidos (APC)',
        estado: 'Vigente',
        generalRate: `${generalRate}%`,
        preferentialRate: generalRate === 0 ? '0%' : 'Por verificar',
        preferenciaAplicable: generalRate === 0 ? 'Sí (0% General)' : 'Por verificar',
        origenDeclarado: 'Estados Unidos de América (US)',
        pruebaOrigen: 'Declaración / Certificado de Origen en Factura o Documento de Embarque',
        fuente: 'MINCETUR / Acuerdos Comerciales del Perú',
        observaciones: generalRate === 0 ? 'La mercancía ya tributa 0% en el Arancel General NMF.' : 'No se pudo verificar automáticamente la preferencia arancelaria. Requiere comprobación del código de 10 dígitos en el cronograma del TLC.'
      },
      'EU': {
        nombre: 'TLC Perú - Unión Europea',
        estado: 'Vigente',
        generalRate: `${generalRate}%`,
        preferentialRate: generalRate === 0 ? '0%' : 'Por verificar',
        preferenciaAplicable: generalRate === 0 ? 'Sí (0% General)' : 'Por verificar',
        origenDeclarado: 'Países Miembros de la Unión Europea (EU)',
        pruebaOrigen: 'Certificado EUR.1 o Declaración de Origen de Exportador Autorizado',
        fuente: 'MINCETUR / Acuerdos Comerciales del Perú',
        observaciones: generalRate === 0 ? 'La mercancía ya tributa 0% en el Arancel General NMF.' : 'No se pudo verificar automáticamente la preferencia arancelaria. Requiere comprobación del código de 10 dígitos en el cronograma del TLC.'
      },
      'CAN': {
        ...
        generalRate: `${generalRate}%`,
        preferentialRate: '0%',
        preferenciaAplicable: 'Sí (Libre Comercio Intracomunitario)',
        origenDeclarado: 'Bolivia, Colombia, Ecuador (CAN)',
        pruebaOrigen: 'Certificado de Origen CAN',
        fuente: 'Comunidad Andina / MINCETUR',
        observaciones: 'Preferencia arancelaria del 100% (0% Ad-Valorem) por programa de liberación de la CAN.'
      },
      'MX': {
        nombre: 'Alianza del Pacífico / TLC Perú-México',
        estado: 'Vigente',
        generalRate: `${generalRate}%`,
        preferentialRate: generalRate === 0 ? '0%' : 'Por verificar',
        preferenciaAplicable: generalRate === 0 ? 'Sí (0% General)' : 'Por verificar',
        origenDeclarado: 'Estados Unidos Mexicanos (MX)',
        pruebaOrigen: 'Certificado de Origen Alianza del Pacífico / TLC',
        fuente: 'MINCETUR / Acuerdos Comerciales del Perú',
        observaciones: generalRate === 0 ? 'La mercancía ya tributa 0% en el Arancel General NMF.' : 'No se pudo verificar automáticamente la preferencia arancelaria. Requiere comprobación del código de 10 dígitos en el cronograma del TLC.'
      }
    };

    return tlcMap[countryCode] || tlcMap['NMF'];
  }
